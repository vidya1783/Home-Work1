...
const groceries = ['Milk', 'Bananas', 'Apples', 'Eggs', 'Bread', 'Yogurt', 'Jam', 'Cheese', 'Carrots', 'Tomatoes'];
 ...
 */
  function setPageTitle() {
      ...
      const pageTitle = document.getElementById('title').innerText ='My Shopping List';
