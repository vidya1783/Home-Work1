...
SELECT COUNT(*) AS Total_states,COUNT(state_nickname) as States_With_Nicknames
FROM state;
...
SELECT state_abbreviation, COUNT(city_id) as cities
FROM  city
...
SELECT state_abbreviation, SUM( population) AS pop
FROM city
 GROUP BY state_abbreviation
