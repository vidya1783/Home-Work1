...
SELECT 'Hello Databases!' AS literal_string;
...
SELECT city_name, area, population FROM city WHERE state_abbreviation IN ('CT', 'ME', 'MA', 'NH','RI');
...
SELECT park_name, area,(area *1000) AS area_in_meters FROM park;
...
SELECT park_name, date_established FROM park WHERE date_established < '01/01/1900';
