...
SELECT COUNT(visitors) FROM park;
...
SELECT * FROM site WHERE utilities = true 
...
SELECT reservation id, site_id, name, from_date, to_date FROM reservation
WHERE from_date = '6/1/2021' AND to_date ='6/30/2021';
...
SELECT COUNT(name) FROM reservation;


-- select reservation id, site id, name of the reservations where site id is in the list 9, 20, 24, 45, 46

SELECT reservation_id, site_id FROM reservation WHERE site_id IN ( 9, 20, 24, 45, 46);
