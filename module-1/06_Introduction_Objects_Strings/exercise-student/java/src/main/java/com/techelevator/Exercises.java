...
public class Exercises {
	...
	public String left2(String str) {
		...
		else {return str.substring(2)+str.substring(0,2);}
	}
	...
	public String right2(String str) {
		if(str.length()<2){return str;}
		else {return str.substring(str.length()-2)+str.substring(0,str.length()-2);}
	...
	public String middleThree(String str) {
		int mThree=str.length()/2;
			{return str.substring((mThree-1), (mThree+2));}
	...
	public String frontTimes(String str, int n) {
		int len=str.length();
		String temp ="";
		if(len<4){for(int i=0;i<n;i++){
			temp+=str;}}
			if (len>4){for(int j=0; j<n;j++){temp+=str.substring(0,3);}}
			return temp;
		}
