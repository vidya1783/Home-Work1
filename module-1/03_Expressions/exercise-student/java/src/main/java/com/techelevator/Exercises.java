...
public class Exercises {
	...
	public boolean in3050(int a, int b) {
		if ((a>=30 && a<=40) && (b>=30 && b<=40) ||
				(a>=40 && a<=50) && (b>=40 && b<=50)){return true;}
		return false;
	}
	...
	public boolean squirrelPlay(int temp, boolean isSummer) {
		...
		if((temp>=60 && temp<=100) && (isSummer == true)){return true;}
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
		if(mealAmount<=5 && isBirthday==false){return"standard";}
		if(mealAmount<=5 && isBirthday==true){return"standard";}
    	if(mealAmount<=10 && isBirthday==false ){return "standard";}
		if(mealAmount<=10 && isBirthday==true){return"special";}
    	if(mealAmount<=15 && isBirthday==false){return"special";}
		if(mealAmount<=15 && isBirthday==true){return"ginormous";}
	...
	public String alarmClock(int day, boolean vacation) {
		if ((day>0 && day!=6) && (vacation == true)){return "10:00";}
		if ((day>0 && day!=6) && (vacation == false)){return "7:00";}
		if((day==0 || day==6) && (vacation == true)){return "off";}
		if((day==0 || day==6) && (vacation == false)){return "10:00";}
		return "";
	}
	...
	public boolean nearTen(int num) {
		if((num%10>=8)||(num%10<=2)){return true;}
		return false;
	}
	...
	public int teenSum(int a, int b) {
		if ((a<13 || a>19) && (b<13 || b>19)){return a+b;}
	...
	public boolean inOrder(int a, int b, int c, boolean bOk) {
		if((b>a && c>b) || (bOk==true && c>b)){return true;}
		return false;
	}
	...
	public boolean inOrderEqual(int a, int b, int c, boolean equalOk) {
		...
		if((b>a && c>b) || ( equalOk== true  && a<=b && b<=c))return true;
